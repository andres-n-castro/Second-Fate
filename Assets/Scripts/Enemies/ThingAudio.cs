...
/// <summary>
/// Audio for the Thing enemy. Handles three things:
...
///   2. A hurt SFX whenever the Thing's Health component takes damage.
///   3. A death SFX whenever the Health component reaches zero.
///
/// Place this component on the same GameObject as the Thing / Health.
...
public class ThingAudio : MonoBehaviour
{
    [Header("Audio Source")]
    ...
    [Header("Damage SFX")]
    [Tooltip("Played whenever this Thing takes damage. One is picked at random.")]
    ...
    [Header("Death SFX")]
    [Tooltip("Played once when this Thing dies. One is picked at random.")]
