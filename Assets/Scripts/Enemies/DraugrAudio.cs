...
/// <summary>
/// Audio for the Draugr enemy. Handles three things:
///   1. Periodic idle "growls" while the player is within detection range
///      (random clip, random pitch, random volume).
///   2. A hurt SFX whenever the Draugr's Health component takes damage.
///   3. A death SFX whenever the Health component reaches zero.
///
/// Place this component on the same GameObject as the Draugr / Health.
...
public class DraugrAudio : MonoBehaviour
{
    [Header("Audio Source")]
    ...
    [Header("Damage SFX")]
    [Tooltip("Played whenever this Draugr takes damage. One is picked at random.")]
    ...
    [Header("Death SFX")]
    [Tooltip("Played once when this Draugr dies. One is picked at random.")]
