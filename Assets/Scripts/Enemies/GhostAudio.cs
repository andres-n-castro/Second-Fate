...
/// <summary>
/// Audio for the Ghost enemy. Handles three things:
...
///   2. A hurt SFX whenever the Ghost's Health component takes damage.
///   3. A death SFX whenever the Health component reaches zero.
///
/// Place this component on the same GameObject as the Ghost / Health.
...
public class GhostAudio : MonoBehaviour
{
    ...
    [Header("Damage SFX")]
    [Tooltip("Played whenever this Ghost takes damage. One is picked at random.")]
    ...
    [Header("Death SFX")]
    [Tooltip("Played once when this Ghost dies. One is picked at random.")]
